...
public class CheckIfNAndItsDoubleExist {
    ...
    /**
     * Given an array arr of integers, check if there exists two integers N and M such that N is the double of M ( i.e.
     * N = 2 * M).
     * <p>
    ...
    public boolean checkIfExist(int[] arr) {
        ...
        for (int n : arr) {
            if (set.contains(2 * n) || ((n / 2.0) % 1 == 0 && set.contains(n / 2))) {
                return true;
            }
