...
class NextInterval {
     ...
     * <p>
     * Write a function to return an array containing indices of the next interval of each input interval. If there is
     * no next interval of a given interval, return -1. It is given that none of the intervals have the same start
     * point.
     *
     * @param intervals
     * @return
    ...
    public static int[] findNextInterval(Interval[] intervals) {
        ...
        PriorityQueue<Integer> maxStartHeap = new PriorityQueue<>(n, (i1, i2) -> intervals[i2].start
                                                                                     - intervals[i1].start);
